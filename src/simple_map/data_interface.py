...
This is the key component that provides the "single source of truth" experience
...
try:
    from master_data_service.data_aggregator import (
        MasterDataAggregator,
        ConsolidatedVenueData,
        ConsolidatedEventData,
        AggregationResult,
    )
    ...
    logging.warning(f"Could not import master data service modules: {e}")
